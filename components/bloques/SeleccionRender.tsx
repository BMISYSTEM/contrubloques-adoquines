...
export const SeleccionRender = () => {
  ...
  return (
    <section className="w-full h-screen bg-blue-300 relative flex items-center justify-center"> 
        <Image src={render === 1 ? "/bloque-p.png" : render === 2 ? "/bloque-m.png" : "/bloque-g.png" } width={1000} height={1000} alt="imagen de bloque" className="w-full h-full md:object-cover object-center"/>
