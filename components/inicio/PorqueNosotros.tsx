    ...
    <>
      ...
      <section className="w-full md:h-screen h-[110vh] bg-black relative flex justify-center ">
        ...
        <div className='md:top-72 top-40 flex flex-wrap w-full absolute md:px-20 px-2 items-center justify-center gap-5 '>
          <Link href={"/#productos"} className='group w-100 h-32 bg-white rounded-lg flex flex-row justify-center items-end '>
          ...
          <Link href={"/nuestro-servicio"} className=' group w-100 h-32 bg-white rounded-lg flex flex-row justify-center items-end '>
            <div className=' flex flex-row justify-between items-center w-full px-4 py-2'>
          ...
          <Link href={"/contactenos"} className='group w-100 h-32 bg-white rounded-lg flex flex-row justify-center items-end '>
            <div className=' flex flex-row justify-between items-center w-full px-4 py-2'>
