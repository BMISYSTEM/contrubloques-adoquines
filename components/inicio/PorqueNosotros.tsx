...
export const PorqueNosotros = () => {
  return (
    <section className="w-full md:h-screen h-[110vh] bg-black relative flex justify-center ">
      ...
      <section className="text-center w-full px-5 absolute bottom-10 flex flex-col gap-5">
        <h4 className='text-5xl font-semibold text-white'>Hablemos de tu próximo proyecto.</h4>
        <p className='text-center text-xl text-white font-semibold'>Te ayudamos a elegir la referencia adecuada en bloques estructurales y adoquines para tu proyecto</p>
        <div>
