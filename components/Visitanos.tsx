...
export const Visitanos = () => {
  return (
    <section className='w-full md:h-screen relative flex items-center'>
        ...
        <div className='w-full h-full absolute  bg-linear-to-r from-black to-transparent'></div>
         <div className='md:w-100 w-full items-start absolute left-10 flex flex-col gap-2 '>
            ...
            <span className='text-6xl font-semibold text-white '>Producción <br/> que construye <br/> confianza <span className='text-amber-500'>.</span></span>
            <span>Tecnología, control y experiencia <br/>para entregar prefabricados de<br/> alta calidad en cada proyecto.</span>
