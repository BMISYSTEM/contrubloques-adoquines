...
import { SeleccionRender } from "@/components/adoquines/SeleccionarRender";
import { ImageCarousel } from "@/components/adoquines/ImageCarousel";
import ScrollStopMotion from "@/components/adoquines/ScrollStopMotion";
import { Mapa } from "@/components/Mapa";
import { Adoquin3d } from "@/components/adoquines/render-adoquines/Adoquin3d";


export const metadata: Metadata = {
  title: "Adoquin - Construbloques&Adoquines",
...
const page = () => {
  ...
  return (
    <>
      <BottonWhatsapp />
      <Navar />
      <section className="w-full overflow-hidden h-[120vh] bg-black relative flex justify-center items-center">
        ...
        <div className="w-full absolute bottom-40 flex flex-col items-center justify-center gap-10">
          <h1 className="md:text-9xl text-6xl  text-white text-center font-bold ">Adoquines</h1>
          <span className="text-xl m-0 p-0 text-white text-center">Desde $1.250</span>
        ...
        <div className="w-full mx-auto  space-y-16">
          <div className="space-y-8 text-center">
            ...
            <h4 className="text-4xl md:text-5xl font-bold leading-tight text-slate-900">
              Calcula material y elige el adoquín ideal para tu proyecto.
            </h4>
          ...
          <section className="w-full h-screen bg-black relative flex justify-center items-end ">
            ...
            <video
              ...
              preload="metadata"
            >
              <source src="/adoquin.MOV" type="video/mp4" />
            </video>
          </section>
        </div>
      </section>
      <section className="overflow-hidden flex flex-col gap-5  text-center pb-5 pt-20 items-center justify-center ">
      ...
      <section className='w-full  h-auto  pt-20 gap-1 pb-20 bg-white flex flex-col items-center '>
        ...
        <div className='flex md:flex-row flex-col gap-1 md:w-250 w-full  '>
          <div className='md:w-2/3 w-full   h-250 rounded-lg bg-gray-500'>
            <Image src={"/adoquinr1.png"} alt='estandares' width={1080} height={1080} className="w-full h-full object-cover" />
          </div>
          <div className='md:w-1/3 w-full   h-96 md:sticky top-0 bg-gray-500 rounded-lg'>
            <Image src={"/adoquinr2.png"} alt='estandares' width={1080} height={1080} className="w-full h-full object-cover" />
          </div>
        </div>
        <div className='flex md:flex-row flex-col gap-1 md:w-250 w-full '>
          <div className='md:w-1/3 w-full h-96  md:sticky top-0 bg-gray-500 rounded-lg'>
            <video
              ...
              preload="metadata"
            >
              <source src="/adoquinr5.mp4" type="video/mp4" />
            </video>
          </div>
          <div className='md:w-2/3 w-full h-250  rounded-lg bg-gray-500'>
            <Image src={"/adoquinr3.png"} alt='estandares' width={1080} height={1080} className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
      <section className="pt-10 pb-10 ">
        ...
        <video
          ...
          preload="metadata"
        >
          <source src="/adoquin-stop-animation/Adoquines.mp4" type="video/mp4" />
        </video>
      </section>
      <Mapa/>
      <section className="flex overflow-hidden flex-col gap-5 mt-10 pb-10 text-center items-center justify-center  pt-10">
      ...
      <section className='w-full md:h-auto overflow-hidden  pb-20 flex flex-wrap md:gap-50 gap-10 items-center justify-center  md:px-20 pt-20 bg-white '>
        {/* columna */}
        <div className='flex flex-col gap-3 justify-center '>
          <Image src={"/adoquin-p.png"} alt="bloque " width={1000} height={1000} className="w-full h-40" />
        ...
        {/* columna */}
        <div className='flex flex-col gap-3 justify-center '>
          <Image src={"/adoquin-g.png"} alt="bloque " width={1000} height={1000} className="w-full h-40" />
      ...
      <section className="w-full h-screen overflow-hidden bg-white items-center justify-center">
        <Adoquin3d />
      </section>
